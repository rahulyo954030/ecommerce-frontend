...
function ProductCard({ product }) {
  ...
  return (
    <div className="bg-gray-50 cursor-pointer rounded-lg shadow-md overflow-hidden flex flex-col transition-transform transform hover:scale-105 hover:shadow-xl">
      {/* Product Image */}
      <img
        src={product.image}
        alt={product.name}
